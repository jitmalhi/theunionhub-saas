...
/**
 * Update mutable fields on a member. Requires a tenant-admin session: since
 * migration 0008, anon and non-admin authenticated callers have no UPDATE
 * policy on members (RLS denies them). The admin UI calls this after
 * requireAuth(). Returns the updated row.
 */
