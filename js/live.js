...
(function () {
  ...
  /* ---- Config (mirrors card.html and verify.html) ---- */
  var SUPABASE_URL = 'https://frdvhmzbsmczknqtexvx.supabase.co';
  var SUPABASE_KEY = 'sb_publishable_mQ5Y9tjHHQmc9gCZPB_tHA_OwHXTc9P';

  var DEMO_IDS = {
    active:    '550bc413-53db-4f83-98e4-7c5c44d721d0',
    inactive:  '21e63983-9b15-4cd6-99e4-179e28cd001e',
    suspended: 'fd1be966-ca25-4e64-8a6a-d3402f1fdb58'
  };
  ...
  function fetchRoster() {
    var ids = [DEMO_IDS.active, DEMO_IDS.inactive, DEMO_IDS.suspended].join(',');
    var url = SUPABASE_URL + '/rest/v1/members?id=in.(' + ids + ')&select=*';
    return fetch(url, { headers: SB_HEADERS, cache: 'no-store' })
      .then(function (r) { return r.ok ? r.json() : []; })
      .catch(function () { return []; });
  }
